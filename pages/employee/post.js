...
export default function post() {
  ...
  return (
    <div>
        ...
        <input type="number" className="form-control" placeholder="ID" onChange={(e) => { setEmployee_id(e.target.value) }}/>
        <br />
        <input type="text" className="form-control" placeholder="ชื่อ" onChange={(e) => { setEmployee_name(e.target.value) }}/>
        <br />
        <input type="text" className="form-control" placeholder="นามสกุล" onChange={(e) => { setEmployee_username(e.target.value) }}/>
        <br />
